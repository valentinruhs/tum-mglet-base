MODULE fields_mod
    ...
    USE precision_mod
    USE field_mod, ONLY: boolfield_t, get_len_i, nchar_name
    ...
    TYPE(boolfield_t), TARGET :: fields(nfields_max)
...
CONTAINS
    ...
    SUBROUTINE set_field(name, description, ndim, istag, jstag, kstag, &
        ...
        ! Local variables
        TYPE(boolfield_t), POINTER :: dummy
        LOGICAL :: exists
    ...
    SUBROUTINE get_field_A(field, name, found)
        ...
        TYPE(boolfield_t), POINTER, INTENT(inout) :: field
        CHARACTER(len=*), INTENT(in) :: name
    ...
    SUBROUTINE get_field_B(fieldarr, name, found)
        ! TODO: Implement dictionary lookup
        LOGICAL, POINTER, INTENT(inout) :: fieldarr(:)
        CHARACTER(len=*), INTENT(in) :: name
        LOGICAL, OPTIONAL, INTENT(out) :: found
    ...
    SUBROUTINE get_fieldptr_grid1(ptr, name, igrid)
        ! Subroutine arguments
        LOGICAL, INTENT(out), POINTER, CONTIGUOUS :: ptr(:)
        CHARACTER(len=*), INTENT(in) :: name
        INTEGER(intk), INTENT(in) :: igrid

        ! Local variables
        TYPE(boolfield_t), POINTER :: field
        LOGICAL :: found
