MODULE intfield_mod
    ...
    USE precision_mod, ONLY: intk, mglet_hdf5_ifk, mglet_mpi_ifk
    USE basefield_mod

    IMPLICIT NONE(type, external)
    PRIVATE

    TYPE, EXTENDS(basefield_t) :: boolfield_t
...
CONTAINS
    SUBROUTINE init(this, name, description, ndim, istag, jstag, kstag, &
        ...
        CLASS(boolfield_t), INTENT(out) :: this
    ...
    ELEMENTAL SUBROUTINE finish(this)
        CLASS(boolfield_t), INTENT(inout) :: this
    ...
    ELEMENTAL SUBROUTINE destructor(this)
        TYPE(boolfield_t), INTENT(inout) :: this
    ...
    SUBROUTINE get_grid1(this, ptr, igrid)
        ! Subroutine arguments
        CLASS(boolfield_t), INTENT(in), TARGET :: this
        LOGICAL, POINTER, CONTIGUOUS, INTENT(out) :: ptr(:)
